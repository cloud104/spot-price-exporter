...
var (
	...
	regions            = flag.String("regions", "", "Comma separated list of AWS regions to get pricing for (required)")
)
...
func main() {
	...
	if len(regions) == 0 {
		log.Fatal("At least one region must be specified using the -regions flag")
	}
